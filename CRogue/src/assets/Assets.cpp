...
void Assets::load() {
	...
	skelyIdle_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton/skely_idle_pow.png", 24);
	skelyRun_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton/skely_run_pow.png", 24);
	skelyAttack_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton/skely_attack_pow.png", 24);
	skelyStunned_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton/skely_stunned_pow.png", 24);
	...
	skelyIdleSW_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton_sword/skely_idle_pow.png", 24);
	skelyRunSW_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton_sword/skely_run_pow.png", 24);
	skelyAttackSW_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton_sword/skely_attack_pow.png", 24);
	skelyStunnedSW_pow = Loader::loadSpriteSheet("data/assets/textures/animations/skeleton_sword/skely_stunned_pow.png", 24);
